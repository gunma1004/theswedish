...
export const regionData: Record<string, RegionInfo> = {
  ...
  cheonan: {
    ...
    districts: {
      cheonan_seobuk: {
        name: "천안시 서북구",
        dongs: ["불당동", "불당1동", "불당2동", "두정동", "성정1동", "성정2동", "백석동", "쌍용1동", "쌍용2동", "쌍용3동", "차암동", "성성동", "부대동", "업성동", "직산읍", "성거읍", "입장면"]
      },
      cheonan_dongnam: {
        name: "천안시 동남구",
        dongs: ["신부동", "청수동", "청당동", "원성1동", "원성2동", "봉명동", "신방동", "일봉동", "중앙동", "문성동", "구성동", "삼용동", "목천읍", "풍세면", "광덕면", "북면", "성남면", "수신면", "병천면", "동면"]
      }
    }
  },
  asan: {
    ...
    districts: {
      asan_main: {
        name: "아산시 전역",
        dongs: ["배방읍", "탕정면", "온천동", "모종동", "풍기동", "용화동", "실옥동", "신창면", "음봉면", "둔포면", "염치읍", "송악면", "도고면", "선장면", "영인면", "인주면"]
      }
    }
  },
  daejeon: {
    ...
    districts: {
      yuseong: {
        name: "유성구",
        dongs: ["봉명동", "상대동", "도안동", "장대동", "궁동", "어은동", "노은1동", "노은2동", "노은3동", "지족동", "반석동", "관평동", "전민동", "원신흥동", "진잠동", "학하동", "신성동", "구즉동"]
      },
      seo: {
        name: "서구",
        dongs: ["둔산1동", "둔산2동", "둔산3동", "탄방동", "월평1동", "월평2동", "월평3동", "만년동", "갈마1동", "갈마2동", "괴정동", "용문동", "가장동", "변동", "도마1동", "도마2동", "정림동", "가수원동", "관저1동", "관저2동", "기성동", "복수동"]
      },
      junggu: {
        name: "중구",
        dongs: ["은행선화동", "대흥동", "문창동", "옥계동", "대사동", "부사동", "용두동", "오류동", "태평1동", "태평2동", "유천1동", "유천2동", "문화1동", "문화2동", "산성동"]
      },
      donggu: {
        name: "동구",
        dongs: ["중앙동", "신인동", "효동", "판암1동", "판암2동", "용운동", "대동", "자양동", "가양1동", "가양2동", "용전동", "성남동", "홍도동", "삼성동", "대청동", "산내동"]
      },
      daedeok: {
        name: "대덕구",
        dongs: ["오정동", "대화동", "회덕동", "비래동", "송촌동", "중리동", "법1동", "법2동", "신탄진동", "석봉동", "덕암동", "목상동"]
      }
    }
  },
  cheongju: {
    ...
    districts: {
      heungdeok: {
        name: "청주시 흥덕구",
        dongs: ["복대1동", "복대2동", "가경동", "봉명1동", "봉명2송정동", "강서1동", "강서2동", "비하동", "운천신봉동", "오송읍", "강내면", "옥산면"]
      },
      seowon: {
        name: "청주시 서원구",
        dongs: ["사직1동", "사직2동", "사창동", "모충동", "산남동", "분평동", "수곡1동", "수곡2동", "성화개신죽림동", "남이면", "현도면"]
      },
      cheongwon: {
        name: "청주시 청원구",
        dongs: ["우암동", "내덕1동", "내덕2동", "율량사천동", "오근장동", "주성동", "주중동", "오창읍", "내수읍", "북이면"]
      },
      sangdang: {
        name: "청주시 상당구",
        dongs: ["중앙동", "성안동", "탑대성동", "영운동", "금천동", "용담명암산성동", "용암1동", "용암2동", "방서동", "동남지구", "낭성면", "미원면", "가덕면", "남일면", "문의면"]
      }
    }
  }
};